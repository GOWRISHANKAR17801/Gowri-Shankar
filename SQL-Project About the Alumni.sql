-- ALUMNI STUDENTS
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
/* In this project SQL project about the almni students of diffrent colleges & which department they were studied,
then which batch the students get passedout these things are found*/
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
...
# Importin the .csv files into MySQL workbench
...
# Running the SQL command to see the structure of six tables
...
/* Displayed the first 1000 rows of tables in python workspace.
...
-- Using mysql.connector library in python I impoted the schema in my python workspace.
-- Displayed the given statements in jupyter Notebook.alter
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --

/* Imported first 1500 rows of tables 
(College_A_HS, College_A_SE, College_A_SJ, College_B_HS, College_B_SE, College_B_SJ) into MS Excel */

-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --

/* Performing data cleaning on table College_A_HS and store cleaned data in view 
...
cleaned data in view College_A_SE_V to Remove null values.*/
...
/* Performing the data cleaning on table College_A_SJ and 
store cleaned data in view College_A_SJ_V to Remove null values.*/
...
/* Performing the data cleaning on table College_B_HS and 
...
/* Performing data cleaning on table College_B_SE and 
store cleaned data in view College_B_SE_V to Remove null values.*/
...
/* Performing the data cleaning on table College_B_SJ and 
store cleaned data in view College_B_SJ_V to Remove null values.*/
...
/* Making procedure to use string functions for converting record of 
...
/* Writing a query to create a procedure as get_name_collegeA using the cursor to 
fetching names of all students from college A.*/
...
/* Writing a query to create procedure 
get_name_collegeB using the cursor to fetching names of all students from college B.*/
DELIMITER $$
